...
import aqcode2Img from "../assets/aqcode2.jpeg";
...
export const MENU_TREE_ID = [
                ...
                children: [
                    {
                        ...
                        footer: "⚠️ Nama, Tempat Lahir, Tanggal Lahir WAJIB SAMA untuk semua dokumen persyaratan.\n\nPetugas wawancara berhak meminta dokumen pendukung apabila ditemukan indikasi penyalahgunaan paspor berdasarkan hasil keterangan pemohon saat wawancara\n\n*berdasarkan Surat Edaran Ditjen Imigrasi Nomor IMI-1308.GR.01.01 Tahun 2024 tentang Pencegahan Tindak Pidana Perdagangan Orang dalam Penerbitan Paspor Biasa",
                        detail: [
                            "KTP",
                            "Kartu Keluarga",
    ...
    },
    {
        ...
        footer: "** : Belum termasuk biaya paspor\n\n*Berdasarkan PP no 45 tahun 2024 tentang Jenis dan Tarif atas Jenis Penerimaan Negara Bukan Pajak yang Berlaku pada Kementerian Hukum dan Hak Asasi Manusia",
    },
    {
        id: "penggantian",
    ...
    },
    {
        ...
        footer: "Batas waktu pengambilan paspor adalah 30 hari sejak diterbitkan. Jika tidak diambil dalam kurun waktu tersebut, maka paspor tersebut akan dibatalkan.\n\n*Dasar Hukum: Pasal 36 ayat 4 Permenkumham RI No. 19 Tahun 2024 tentang Perubahan Kedua atas Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2014 tentang Paspor Biasa dan Surat Perjalanan Laksana Paspor.",
        children: [
            {
                id: "pengambilan-paspor-baru",
                title: "Pengambilan Paspor Baru",
                desc: "Syarat pengambilan paspor baru",
                footer: "Batas waktu pengambilan paspor adalah 30 hari sejak diterbitkan. Jika tidak diambil dalam kurun waktu tersebut, maka paspor tersebut akan dibatalkan.\n\n*Dasar Hukum: Pasal 36 ayat 4 Permenkumham RI No. 19 Tahun 2024 tentang Perubahan Kedua atas Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2014 tentang Paspor Biasa dan Surat Perjalanan Laksana Paspor.",
                children: [
                    {
                        id: "pemohon",
            ...
            {
                id: "pengambilan-paspor-lama",
                title: "Pengambilan Paspor Lama",
                desc: "Syarat pengambilan paspor lama",
                detail: [
                    { isImage: true, src: aqcode2Img },
                ],
            },
        ],
    },
...
export const MENU_TREE_EN = [
                ...
                children: [
                    {
                        ...
                        footer: "⚠️ Full Name, Place of Birth, and Date of Birth MUST BE IDENTICAL across all required documents.\n\nThe interview officer reserves the right to request supporting documents if there is an indication of passport misuse based on the applicant's statement during the interview\n\n*based on the Circular Letter of the Directorate General of Immigration Number IMI-1308.GR.01.01 Year 2024 concerning the Prevention of the Crime of Trafficking in Persons in the Issuance of Ordinary Passports",
                        detail: [
                            "ID Card (KTP)",
                            "Family Card",
    ...
    },
    {
        ...
        footer: "** : Does not include passport fee\n\n*Based on Government Regulation (PP) No. 45 of 2024 concerning Types and Tariffs on Non-Tax State Revenues Applicable to the Ministry of Law and Human Rights",
    },
    {
        id: "penggantian",
    ...
    },
    {
        ...
        iconSrc: iconPengambilan,
        footer: "The deadline for collecting the passport is 30 days after it is issued. If it is not collected within this period, the passport will be cancelled.\n\n*Legal Basis: Article 36 Paragraph 4 of Permenkumham RI No. 19 of 2024 concerning the Second Amendment to the Regulation of the Minister of Law and Human Rights Number 8 of 2014 concerning Ordinary Passports and Passport-Like Travel Documents.",
        children: [
            {
                id: "pengambilan-paspor-baru",
                title: "New Passport Collection",
                desc: "Requirements for collecting a new passport",
                footer: "The deadline for collecting the passport is 30 days after it is issued. If it is not collected within this period, the passport will be cancelled.\n\n*Legal Basis: Article 36 Paragraph 4 of Permenkumham RI No. 19 of 2024 concerning the Second Amendment to the Regulation of the Minister of Law and Human Rights Number 8 of 2014 concerning Ordinary Passports and Passport-Like Travel Documents.",
                children: [
                    {
                        id: "pemohon",
            ...
            {
                id: "pengambilan-paspor-lama",
                title: "Old Passport Collection",
                desc: "Requirements for collecting an old passport",
                detail: [
                    { isImage: true, src: aqcode2Img },
                ],
            },
